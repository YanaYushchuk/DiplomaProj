    ...
    return (
        ...
        <Link to={'/'} className="flex items-center gap-1"> 
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="blue" className="w-6 h-6">
          ...
          <span  className="font-bold text-xl">HappyTrip</span>
        </Link>
        <div className="flex gap-2 border border-blue-500 rounded-full shadow-lg shadow-blue-200">
        <div>Місце</div>
        ...
        <div className="border-l border-blue-300"></div>
        <button className="bg-primary  p-0.5 rounded-full">
        ...
        <Link to={'/login'} className="flex gap-2 border border-blue-500 rounded-full shadow-lg shadow-blue-200 p-0.5">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="blue" className="w-6 h-6 relative top-1">
