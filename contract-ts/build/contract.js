...
let TicketBook = (_dec = NearBindgen({}), _dec2 = call({
  payableFunction: true
}), _dec3 = view(), _dec4 = view(), _dec(_class = (_class2 = class TicketBook {
  instances = new Vector("v-uid");
...
}, (_applyDecoratedDescriptor(_class2.prototype, "buy_ticket", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "buy_ticket"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_tickets", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_tickets"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "total_tickets", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "total_tickets"), _class2.prototype)), _class2)) || _class);
function total_tickets() {
  const _state = TicketBook._getState();
  if (!_state && TicketBook._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = TicketBook._create();
  if (_state) {
    TicketBook._reconstruct(_contract, _state);
  }
  const _args = TicketBook._getArgs();
  const _result = _contract.total_tickets(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TicketBook._serialize(_result, true));
}
function get_tickets() {
  ...
  const _args = TicketBook._getArgs();
  const _result = _contract.get_tickets(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TicketBook._serialize(_result, true));
}
function buy_ticket() {
  const _state = TicketBook._getState();
  ...
  const _args = TicketBook._getArgs();
  const _result = _contract.buy_ticket(_args);
  TicketBook._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TicketBook._serialize(_result, true));
}

export { buy_ticket, get_tickets, total_tickets };
